 ...
 */
final class Version20210201171113 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article ADD knowledge_id INT DEFAULT NULL, ADD type VARCHAR(255) DEFAULT NULL, CHANGE content content LONGTEXT DEFAULT NULL');
